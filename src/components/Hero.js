  ...
  return (
    <div id="hero">
      ...
      <div className="w-full h-screen absolute top-0 left-0 md:bottom-4 bg-white/50">
        ...
        <div className="invisible md:visible absolute top-0 left-0 md:w-64 lg:w-80 p-5 rounded-br-xl bg-gray-700">
        ...
        <div className="max-w-[700px] m-auto h-full flex flex-col justify-end px-5 py-12">
          ...
          <h2 className="text-sm text-justify md:text-lg text-gray-700 rounded-2xl bg-orange-100 p-3 leading-6">
