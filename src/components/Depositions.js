  ...
  return (
    <div id="depoimentos" className="p-5 pt-10">
      ...
      <div className="w-full m-auto py-4 px-2 relative">
        ...
        {/* Left Arrow */}
        <div className="absolute top-[40%] -translate-x-0 translate-y-[50%] -left-5 md:left-44 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer">
          <BsChevronCompactLeft onClick={prevSlide} size={30} />
        </div>
        {/* Right Arrow */}
        <div className="absolute top-[40%] -translate-x-0 translate-y-[50%] -right-5 md:right-44 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer">
