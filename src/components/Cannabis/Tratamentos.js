...
const Tratamentos = () => {
  const contents = [
    {
      id: 1,
      icon: <FaCannabis size={50} color='003E53' />,
    ...
    {
      id: 2,
      icon: <FaFrownOpen size={50} color='003E53' />,
      title: "Ansiedade",
    ...
    {
      id: 3,
      icon: <FaMehRollingEyes size={50} color='003E53' />,
      title: "Insônia",
    ...
    {
      id: 4,
      icon: <FaSadTear size={50} color='003E53' />,
      title: "Depressão",
  ...
  return (
    <div id="tratamentos" className="p-5 bg-[#CDBCA8]">
      <div className="mb-10">
        ...
        <h2 className="text-4xl font-bold text-[#003E53] text-center uppercase underline decoration-[#7C5A12] underline-offset-8">
          te ajudar
        </h2>
      </div>
