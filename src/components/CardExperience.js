...
const CardExperience = () => {
  return (
    <div className="w-full mx-auto group shadow-2xl rounded-bl-2xl transform duration-500 hover:-translate-y-2 bg-[#003E53] text-stone-700 p-4 lg:py-8 lg:px-5">
        ...
        <div className='flex justify-between items-center mt-8 border-l-4 pl-2 border-l-[#CDBCA8]'>
        ...
        <div className='flex justify-between items-center mt-4 border-l-4 pl-2 border-l-[#CDBCA8]'>
